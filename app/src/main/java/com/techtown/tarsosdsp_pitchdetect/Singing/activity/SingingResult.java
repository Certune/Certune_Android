...
public class SingingResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(() -> {
            Log.v("score", "2");
            totalScoreView.setText(Double.toString(totalScore));
            noteScoreTextView.setText(Double.toString(noteScore));
            rhythmScoreTextView.setText(Double.toString(rhythmScore));
        }, 3000);
